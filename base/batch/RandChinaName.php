 ...
 * @version: 1.5.0
 * @change:
 *    1. 2019/10/24 leixu: 创建；
 */

Class RandChinaName
{
    protected static $surnameArray = [
    ...
    protected static $nameNum = 0;
    protected static $surnameNum  = 0;

    public function __construct()
    {
        self::$surnameNum = count(self::$surnameArray);
        self::$nameNum = count(self::$nameArray);
    }

    private function getSurname()
    {
        return self::$surnameArray[mt_rand(0, self::$surnameNum - 1)];
    }

    private function getName()
    {
        return self::$nameArray[mt_rand(0, self::$nameNum - 1)];
    }

    public function rndChinaName($type = 2)
    {
        switch ($type) {
            case 1:    //2字
            ...
            case 2:    //随机2、3个字
                $name = $this->getSurname() . $this->getName();
                if (mt_rand(0, 100) > 50) $name .= $this->getName();
                break;
            case 3: //只取姓
            ...
            case 0:
            default:
                $name = $this->getSurname() . $this->getName() . $this->getName();
        }
